...
products.each do |product|
  ...
  Product.find_or_create_by(title: product[:title], product_description: product[:product_description], price: product[:price], old_price: product[:old_price], exclusive_price: product[:exclusive_price], product_details: product[:product_details], category_id: category.id, is_published: product[:is_published], sub_category_id: sub_category.id, is_recommended: product[:is_recommended], quantity: product[:quantity])
end
puts 'products saved'
puts ''
